...
const UsersStore = Reflux.createStore({
  ...
  _setDatabaseUsers(dbName) {
    ...
    /**
    * This command queries the admin.system.users collection for users
    * where the db field matches the database currently being viewed.
    */
    window.app.dataService.find('admin.system.users', filter, findOptions,
       ...
       * This change is reflected in the component and the displayed
       * user list updates accordingly.
      */
