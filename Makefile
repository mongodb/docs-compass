...
.PHONY: help html stage publish-artifacts fake-deploy deploy
...
deploy:
	...
	mut-publish build/public ${PRODUCTION_BUCKET} --prefix=${PREFIX} --all-subdirectories --deploy ${ARGS}  --redirects build/public/.htaccess
